        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
            <div className="lg:col-span-8 space-y-4 max-w-2xl">
              ...
              <p className="text-lg sm:text-xl text-brand-300 font-medium max-w-lg">{solution.tagline}</p>
            ...
            <div className="lg:col-span-4 rounded-2xl border border-white/10 bg-navy-900/40 p-6 space-y-4 shadow-xl backdrop-blur-xl transition-all duration-300 hover:border-brand-500/30">
