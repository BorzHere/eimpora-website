    ...
    <div className="space-y-0">
      ...
      <section className="relative py-24 bg-slate-50 text-navy-950 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
            ...
            <div className="lg:col-span-7 rounded-2xl border border-brand-500/30 bg-navy-950 text-white p-6 space-y-4 shadow-xl shadow-brand-500/5">
              <div className="flex items-center justify-between border-b border-white/10 pb-3">
                <span className="text-xs font-bold uppercase tracking-wider text-brand-400">Eimpora Unified State</span>
                <span className="text-[10px] font-semibold text-brand-400 bg-brand-500/10 border border-brand-500/20 px-2.5 py-0.5 rounded-full">1 Connected Operating Substrate</span>
              </div>
              ...
              <p className="text-xs text-slate-300 font-semibold">Zero-penny payroll discrepancies, real-time biometric synchronization, and 100% auditable workflow execution.</p>
            </div>
          </div>
        </div>
      </section>
              ...
              return (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <h3 className="font-display font-bold text-lg text-white group-hover:text-brand-400 transition-colors">{layer.title}</h3>
      ...
      <section className="relative py-24 bg-white text-navy-950 border-y border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-8">
            <div className="flex flex-wrap items-center justify-start gap-2 p-1.5 rounded-xl border border-slate-200 bg-slate-100 max-w-xl  mb-8">
              {[
