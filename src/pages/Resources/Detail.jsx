...
export default function ResourceDetail() {
  ...
  return (
    <div className="relative overflow-hidden space-y-16 pt-32 pb-12">
      <Stars />
      {/* Container */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          ...
          <p className="text-base sm:text-lg text-slate-300 leading-relaxed border-l-2 border-brand-500/50 pl-4 py-1">
            {res.summary}
          </p>
          ...
          {res.sections.map((sec, idx) => (
            ...
            >
              ...
              <div className="pt-3 border-t border-white/5 flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="text-brand-300 font-semibold">Verified Spec</span>
              </div>
            </div>
          ))}
        </div>
